...
Здесь собраны решения задач по курсу "Языки и методы программирования", читаемом на I и II семестрах ПМИ ФАЛТ. Весь материал предоставляется неофициально и в образовательных целях. Тупой скат - путь в никуда! Перед сдачей зачёта рекомендуется ознакомиться с основными конструкциями языка(ов) и потестировать соответствующие интерпретаторы.
